...
@section('content')
    ...
    <section class="section">
        <div class="container">
            <form id="retailer-form" class="form dashboard-form" action="{{ route('retailers.update', [$retailer->id]) }}"
                method="POST">
                @csrf
                @method('put')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-md-12 text-end form-group align-self-end">
                                <a href="{{ route('retailers.address.destroy',$address->id)}}" class="btn btn-danger removeRow">Remove</a>
                            </div>
                    </div>
                 </div>
