                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            This is to notify You that Your account has been Created in the Collective
                                            Data Portal.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Please Click on the Below links to fill your Information
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="{{ route('lps.get-form', [$user->id]) }}"
                                                            style="color: #ffffff; text-decoration: none;">Add Info</a>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td align="left"
                                                    ...
                                                    <div
                                                        ...
                                                        Email us: <br /> <a href="mailto:"
                                                            style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">cdp@adminPanel.com</a>
                                                    </div>
                                                </td>
                                            </tr>
