                            ...
                            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">Retailer has submitted the form you
                                                can Go to the portal and approve the retailer.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px"><b>Owner
                                                    Name : </b>{{ $request->owner_name }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px"><b> Email :
                                                </b>{{ $request->email }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px"><b>DBA :
                                                </b>{{ $retailer->DBA }}
                                            </p>
                                        </td>
                                    </tr>
