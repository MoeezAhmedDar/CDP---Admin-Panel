                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            ...
                                            <p style="margin: 0; line-height: 25px ">
                                                This is to notify That Retailer has Filled the provided information.
                                                Please Login into your portal and change the status of
                                                Retailer. <br><br>Click the below button to log in.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
