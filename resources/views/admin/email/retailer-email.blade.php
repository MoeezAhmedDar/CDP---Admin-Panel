                                            ...
                                            <p style="margin: 0 0 10px;">
                                                <span
                                                    style="width:18px;display: inline-block;vertical-align: middle;margin:-4px 10px 0 0;"><img
                                                        src="{{ asset('admin/images/people.svg') }}" alt=""
                                            ...
                                            <p style="margin: 0 0 10px;">
                                                <span
                                                    style="width:15px;display: inline-block;vertical-align: middle;margin:-4px 14px 0 0;"><img
                                                        src="{{ asset('admin/images/mail.svg') }}" alt=""
                                                        style="width: 100%; display: block"></span>
                                                <a href=""
                                            ...
                                            <p style="margin: 0 0 10px;">
                                                <span
                                                    style="width:8px;display: inline-block;vertical-align: middle;margin:-4px 22px 0 0;"><img
                                                        src="{{ asset('admin/images/phone.svg') }}" alt=""
                                                        style="width: 100%; display: block"></span>
                                                780-686-0037
                                            </p>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            ...
                                            <p style="margin: 0; line-height: 25px">The <b>IRCC Team</b> Recently added
                                                you as a Retailer, <b>To be a part of the Retailer Team</b> , Please
                                                click the button below, fill out the form, and submitted it.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; margin: 0 auto; font-size: 16px; font-family: sans-serif;"
                                            align="center" valign="middle">
                                            <a href="{{ route('retailers.get-form', [$user->id]) }}"
                                                style="background-color: #3b5574; color: #fff; padding: 15px 20px; text-decoration: none; border-radius: 4px; display: inline-block; vertical-align: top;">Register
                                                Now</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">As you submitted it, <b>IRCC
                                                    Team</b> will review it and will get back to you
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px"><b>Thanks!</b></p>
                                        </td>
                                    </tr>
                                    <tr>
