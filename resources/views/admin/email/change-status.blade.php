                            ...
                            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px ">Thank you for contacting <b>IRCC
                                                    Data Portal</b>. We appreciate your interest in working with us,
                                                Your Request for Registrations has been <b>Approved by the IRCC
                                                    Team</b>.
                                                <br><br>Click the below button to log in.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; margin: 0 auto; font-size: 16px; font-family: sans-serif;"
                                            align="center" valign="middle">
                                            <a href="{{ route('login') }}"
                                                style="background-color: #3b5574; color: #fff; padding: 15px 20px; text-decoration: none; border-radius: 4px; display: inline-block; vertical-align: top;">Login</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">Once in the <b>IRCC Data Portal</b>,
                                                you will be able to <b>Upload your Data Report</b> into the <b>SSL IRCC
                                                    Data Portal</b>. Please follow the steps below to ensure a
                                                successful upload of the <b>Data Report</b> you choose to submit: </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 0px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p
                                                style="margin: 0; padding: 0 0 20px; line-height: 25px; font-weight: bold;">
                                                Steps to successful Data Report upload and submission :</p>
                                            ...
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 7:</span> Click <b>FINISH</b>
                                            </p>
                                        </td>
                                    </tr>
