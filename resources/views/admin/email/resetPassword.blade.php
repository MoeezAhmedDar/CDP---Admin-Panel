                    ...
                    <tr>
                        <td style="background-color: #fff;  font-family: sans-serif;" valign="middle">
                            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 25px 30px 5px; font-size: 16px; font-weight: bold; font-family: sans-serif; display:none;"
                                            align="right" valign="middle">
                                            {{ Carbon\Carbon::now()->format('d F Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">Welcome to the <b>IRCC Retailer Data
                                                    Portal</b> - We're thrilled to see you here!</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">The <b>IRCC Team</b> Recently added
                                                you as a Retailer <b>to reset the password for your Retailer portal
                                                    account</b>. Click the button below to proceed.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 30px 25px; margin: 0 auto; font-size: 16px; font-family: sans-serif;"
                                            align="center" valign="middle">
                                            <a href="{{ route('password.reset', $details['token']) }}"
                                    ...
                                    <tr>
                                        <td style="padding: 0px 30px 25px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px">As you set your new password you’re
                                                redirected to the <b>Login</b> Screen by entering your email address and
                                                new password you’re successfully logged in to the Portal.
                                            </p>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style=" padding: 0px 30px 0px; font-size: 16px; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">And the next
                                                step is to <b>Upload the Report in the Portal</b>, here are the steps
                                                for Uploading Report.</p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 1:</span> Click on the <b>Upload
                                                    Report Button</b>
                                            </p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 2:</span> Select the
                                                <b>Location</b>
                                            </p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 3:</span> Select the <b>POS</b>
                                            </p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 4:</span> Choose the
                                                <b>Diagnostic Report</b>
                                            </p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 5:</span> Choose the <b>Sales
                                                    Summary Report</b>
                                            </p>
                                            <p style="margin: 0; padding: 0 0 20px; line-height: 25px;">
                                                <span style="font-weight: bold;">Step 6:</span> <b> Upload Files </b>
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style=" padding: 0px 30px 20px; font-size: 16px; font-family: sans-serif;"
                                            ...
                                            <p style="margin: 0; font-size: 14px; line-height: 25px;">
                                                Please contact Chris Felgate, Head of Operations, if you require
                                                assistance.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style=" padding: 0px 30px 20px; font-size: 16px; font-weight: bold; font-family: sans-serif;"
                                            align="left" valign="middle">
                                            <p style="margin: 0; line-height: 25px;">Chris Felgate</p>
                                            <p style="margin: 0; line-height: 25px;"><a href=""
                                                    style="color: #000">chris@irccollective.com</a></p>
