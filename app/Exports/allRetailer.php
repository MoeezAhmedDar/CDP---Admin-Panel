...
class allRetailer implements FromCollection, WithMapping, WithHeadings
{

    public function collection()
    {
        return RetailerStatement::where('retailerReportSubmission_id', '>=', 2569)->with('reportsubmissions.retailer')->get();
    }
